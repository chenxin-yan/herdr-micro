...
- [ ] `herdr-micro up` and `down` control the shared launchd service; `uninstall` removes only a CLI-managed registration and preserves the CLI, config, logs, and Deck
